...
if __name__ == "__main__":
    ...
    if not id_to_region_map:
        ...
        sample_cleaned_data = [
            {'번호': 684, '지역거주여부 상세내용': '○ 공고일 기준 본인 또는 부모(친권자/후견인) 중 1인 이상 원덕읍 관내에 3년이상 주민등록상 거주하고 있는 자'},
            {'번호': 805, '지역거주여부 상세내용': '○ 원덕읍 관내 중학교 또는 고등학교 졸업한 학생'},
            {'번호': 945, '지역거주여부 상세내용': '○ 경상북도 울진군 출신 학생'},
            {'번호': 1013, '지역거주여부 상세내용': '○ 광주광역시 광산구 거주자'},
            {'번호': 9999, '지역거주여부 상세내용': '○ 서울특별시 강남구 삼성동 거주 학생'} # 읍/면/동 테스트용
        ]
