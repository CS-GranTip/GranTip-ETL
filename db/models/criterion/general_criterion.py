...
from sqlalchemy import Column, BIGINT, Integer, ForeignKey, TEXT, TIMESTAMP, text
...
class GeneralCriterion(Base):
    ...
    scholarship_id = Column(BIGINT, ForeignKey("scholarship.id"), comment="Scholarship ID (PK, FK)")
