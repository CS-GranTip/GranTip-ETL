...
scholarship_university_category_table = Table(
    ...
    Base.metadata,
    Column('scholarship_id', Integer, ForeignKey('scholarship.id'), primary_key=True),
    Column('university_category_id', Integer, ForeignKey('university_category.id'), primary_key=True)
)
